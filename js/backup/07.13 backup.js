...
*/
        ...
        ,
        function: (hero)=>{
            if (hero.idx == 0 && hero_list[1].hp + 10 <= hero_list[1].maxhp)
                hero_list[1].hp = hero_list[1].hp + 10;
            else if (hero.idx == 1 && hero_list[0].hp + 10 <= hero_list[0].maxhp)
                hero_list[0].hp = hero_list[0].hp + 10;
    ...
    skill_list.push({
        ...
        function: (hero)=>{
            ...
            hero.attackRate = hero.attackRate / 3;
    ...
    function stand(e) {
        ...
        case 65:
            ...
            if (hero_list[1].char == 'adcarry') {
                ...
                $(`#charging_${1}`).css("background-color", '#fff186');
            } else if (hero_list[1].char == 'healer') {
                hero_list[1].attack(hero_list[1].attackGauge, hero_list[1].damage + 3);
                hero_list[1].attackGauge = 0;
                $(`#charging_${1}`).css("width", '0%');
                $(`#charging_${1}`).css("background-color", '#fff186');
        ...
        case 25:
            ...
            if (hero_list[0].char == 'adcarry') {
                ...
                $(`#charging_${0}`).css("background-color", '#fff186');
            } else if (hero_list[0].char == 'healer') {
                hero_list[0].attack(hero_list[0].attackGauge, hero_list[0].damage + 3);
                hero_list[0].attackGauge = 0;
                $(`#charging_${0}`).css("width", '0%');
                $(`#charging_${0}`).css("background-color", '#fff186');
