...
//width, height, left, bottom, whichPlayer, arrow, idx, degree, rushSpeed, attackRange, damage, 
            ...
            switch (this.whichDirectionDoesHeGo) {
                    ...
                    case 68:
                        where = 'Left';
                        this.#projection.left.push(new Projection({
                            width : width,
                            height : height,
                    ...
                    case 71:
                        where = 'Right';
                        this.#projection.right.push(new Projection({
                            width : width,
                            height : height,
                    ...
                    case 82:
                        where = 'Forward';
                       this.#projection.up.push(new Projection({
                           width : width,
                           height : height, 
                    ...
                    case 70:
                        where = 'Down';
                       this.#projection.bottom.push(new Projection({
                           width : width,
                           height : height,
                           left : this.coordinates.x-width/2 ,
                ...
                switch (this.whichDirectionDoesHeGo) {
                    ...
                    case 68:
                        ...
                        this.#projection.left.push(new Projection({
                            ...
                            rushSpeed : {left : -rushSpeed*Math.cos(rushSpeed*(i+1) * Math.PI / 180), bottom : rushSpeed*Math.sin(rushSpeed*(i+1) * Math.PI / 180), },
                            attackRange : this.attacking.range,
                            damage : this.attacking.damage/damageRate,
                        }));
                    ...
                    case 82:
                        ...
                        this.#projection.up.push(new Projection({
                            ...
                            _class : `dealerAttack dealerAttack${where}`,
                            degree : rushSpeed*(i+1),
                            rushSpeed : {left : rushSpeed*Math.sin(rushSpeed*(i+1) * Math.PI / 180), bottom : rushSpeed*Math.cos(rushSpeed*(i+1) * Math.PI / 180) },
                            attackRange : this.attacking.range,
                            damage : this.attacking.damage/damageRate,
                        }));
    ...
    moveAnimation(){
         let where;
            ...
            if(this.attacking.bool){
                if (this.whichMotion > 32)
                    motionNum = 4;
                else if (this.whichMotion > 24)
                    motionNum = 3;
                else if (this.whichMotion > 16)
                    motionNum = 2;
                else if (this.whichMotion > 8)
                    motionNum = 1;
