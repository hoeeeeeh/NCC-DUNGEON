class Stage {
  ...
  #STAGES = [
    ...
    function () {
      let monster = 0;
      return [new kingBat(50, 70, monster++)];
    },
    ...
    function () {
      let monster = 0;
      return [
        new normalPenguin(30, 70, monster++, true),
        new normalPenguin(70, 70, monster++, true),
        new kingPenguin(40, 70, monster++, true),
        new kingPenguin(60, 70, monster++, true),
  ...
  backgroundImage() {
    $("#wrapper").css(
      "background-image",
      `url(./img/background/background_${this.#chapter}.png)`
    );
    console.log(`background = ${this.#chapter}`);
  }
  ...
  stageHighLight() {
    if ((this.#nowStage + 1) % 4 == 0 && this.#nowStage > 0) {
      ...
      $("#stage_num").css(
        "background-image",
        `url(./img/stage/STAGE${this.#nowStage + 1}.png)`
      );
